...
export class ProductService {
  ...
  productLists: Product[] = [
    ...
    { id: 4, picture: "https://images.unsplash.com/photo-1549298916-f52d724204b4?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1301&q=80", description: "Originally designed for performance hoops, Nike Air cushioning adds lightweight", price: "899", name: "Nike" },
